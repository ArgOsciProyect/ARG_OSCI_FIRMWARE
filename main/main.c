...
void app_main(void)
{
    ...
    // Inicializar NVS (Non-Volatile Storage) para almacenamiento de configuraciones
    ...
    init_pulse_counter();     // Inicializar contador de pulsos para detección de flancos
